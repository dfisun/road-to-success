# Сравнение Таллинского Технического и Тартуского университетов (2018)
...
В списке есть модули предметов по выбору -- это значит, что из списка valikained нужно набрать предметы на требуемое количество пунктов (vähemalt: x EAP). Для просмотра описания предмета нужно щелкнуть на его код (например, ICA0001).
